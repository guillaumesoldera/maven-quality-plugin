...
public class PomFileReader {
  ...
  } //-- ActivationFile parseActivationFile(String, XmlPullParser, boolean, String) 
  ...
  } //-- ActivationProperty parseActivationProperty(String, XmlPullParser, boolean, String) 
  ...
  } //-- ConfigurationContainer parseConfigurationContainer(String, XmlPullParser, boolean, String) 
  ...
  } //-- DependencyManagement parseDependencyManagement(String, XmlPullParser, boolean, String) 
  ...
  } //-- DeploymentRepository parseDeploymentRepository(String, XmlPullParser, boolean, String) 
  ...
  } //-- DistributionManagement parseDistributionManagement(String, XmlPullParser, boolean, String) 
   ...
   * @param parser
   */
  private Exclusion parseExclusion(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
   ...
   * @param parser
   */
  private Extension parseExtension(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
  ...
  } //-- IssueManagement parseIssueManagement(String, XmlPullParser, boolean, String) 
      ...
      throws IOException, XmlPullParserException
  {
      ...
      while ( eventType != XmlPullParser.END_DOCUMENT )
      {
          ...
          {
            getLog().info("line number = " + parser.getLineNumber() + " tag = " + parser.getName());
...
//                  model.setPrerequisites( parsePrerequisites( "prerequisites", parser, strict, encoding ) );
              }
...
//                  model.setIssueManagement( parseIssueManagement( "issueManagement", parser, strict, encoding ) );
              }
...
//                  model.setCiManagement( parseCiManagement( "ciManagement", parser, strict, encoding ) );
              }
...
//                  model.setReporting( parseReporting( "reporting", parser, strict, encoding ) );
              }
...
//                  model.setDependencyManagement( parseDependencyManagement( "dependencyManagement", parser, strict, encoding ) );
              }
...
//                  model.setDistributionManagement( parseDistributionManagement( "distributionManagement", parser, strict, encoding ) );
              }
              else if ( parser.getName().equals( "properties" )  )
              {
//                  if ( parsed.contains( "properties" ) )
...
//                  }
   ...
   * @param parser
   */
  private Notifier parseNotifier(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
   ...
   * @param parser
   */
  private Parent parseParent(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
   ...
   * @param parser
   */
  private PluginExecution parsePluginExecution(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
  ...
  } //-- PluginExecution parsePluginExecution(String, XmlPullParser, boolean, String) 
   ...
   * @param parser
   */
  private PluginManagement parsePluginManagement(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
  ...
  } //-- PluginManagement parsePluginManagement(String, XmlPullParser, boolean, String) 
   ...
   * @param parser
   */
  private Prerequisites parsePrerequisites(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
  ...
  } //-- Prerequisites parsePrerequisites(String, XmlPullParser, boolean, String) 
   ...
   * @param parser
   */
  private Relocation parseRelocation(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
   ...
   * @param parser
   */
  private ReportPlugin parseReportPlugin(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
   ...
   * @param parser
   */
  private RepositoryBase parseRepositoryBase(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
  ...
  } //-- RepositoryBase parseRepositoryBase(String, XmlPullParser, boolean, String) 
   ...
   * @param parser
   */
  private RepositoryPolicy parseRepositoryPolicy(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
  ...
  } //-- RepositoryPolicy parseRepositoryPolicy(String, XmlPullParser, boolean, String) 
   ...
   * @param parser
   */
  private Scm parseScm(String tagName, XmlPullParser parser, boolean strict, String encoding)
      throws IOException, XmlPullParserException
  {
      Scm scm = new Scm();
  ...
  /**
   * Method read.
   * Parse pom file and loos if Maven conventions (tags order, skip lines) are OK.
   * 
   * @param reader
   */
